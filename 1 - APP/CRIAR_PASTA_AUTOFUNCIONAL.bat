@echo off
title Criar Pasta 1 - APP Autofuncional
echo ===============================================
echo    CRIAR PASTA 1 - APP AUTOFUNCIONAL
echo ===============================================
echo.
...
echo 1. Download do Python portavel
...
REM Instalar pip no Python portavel
"python_portavel\python.exe" -m ensurepip --upgrade
...
echo ===============================================
echo    PASSO 6: ORGANIZANDO PASTA AUTOFUNCIONAL
echo ===============================================
echo.
