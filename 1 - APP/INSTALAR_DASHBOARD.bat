...
for %%F in ("%~dp0auth_simple.py","%~dp0Extracao.py","%~dp0usuarios.json","%~dp0usuarios_padrao.json","%~dp0dados_equipe.json") do (
...
if exist "%~dp0pages" xcopy "%~dp0pages\*" "%INT%\pages\" /E /I /Y >nul
if exist "%~dp0KE5Z" xcopy "%~dp0KE5Z\*" "%INT%\KE5Z\" /E /I /Y >nul
